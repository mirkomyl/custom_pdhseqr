...
*                                                                     *
***********************************************************************
      INTEGER FUNCTION PILAENVX_( ICTXT, ISPEC, NAME, OPTS, N1, N2, N3,
     $                           N4 )
*
...
*  =======
*
*  PILAENVX_ is called from the ScaLAPACK routines to choose problem-
...
*               where k is given by PILAENVX_(2,...) and m by PILAENVX_(5,...)
...
*               see PIPARMQ_ for detailed explanation
*          17 <= ISPEC <= 22:
...
*          be required.
*
* (PILAENVX_) (global output) INTEGER
*          >= 0: the value of the parameter specified by ISPEC
*          < 0:  if PILAENVX_ = -k, the k-th argument had an illegal value.
*
*  Further Details
*  ===============
*
...
*     ..
*     .. External Functions ..
      INTEGER            IEEECK, PIPARMQ_, ICEIL
      EXTERNAL           IEEECK, PIPARMQ_, ICEIL
*     ..
...
*
      PILAENVX_ = INT( REAL( MIN( N1, N2 ) )*1.6E0 )
      RETURN
*
  110 CONTINUE
*
...
*     PILAENVX_ = 0
      PILAENVX_ = 1
      IF( PILAENVX_.EQ.1 ) THEN
         PILAENVX_ = IEEECK( 0, 0.0, 1.0 )
      END IF
      RETURN
*
  150 CONTINUE
...
*
      PILAENVX_ = PIPARMQ_( ICTXT, ISPEC, NAME, OPTS, N1, N2, N3, N4 )
      RETURN
*
  170 CONTINUE
*
...
*
      ...
      PILAENVX_ = MIN( ICEIL(N1,N2), MIN( NPROW, NPCOL) )
      RETURN
*
  180 CONTINUE
*
...
*
      NTHRESH = 384
      PILAENVX_ = ICEIL(N1, ICEIL(NTHRESH, N2)*N2)
      RETURN
  990 CONTINUE
*
