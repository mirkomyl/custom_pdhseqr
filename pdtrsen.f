...
*                                                                     *
***********************************************************************
      SUBROUTINE PDTRSEN_( JOB, COMPQ, SELECT, PARA, N, T, IT, JT,
...
*  =======
*
*  PDTRSEN_ reorders the real Schur factorization of a real matrix
...
*  be activated in future releases combining SCASY and PDHSEQR_.
*
*  T must be in Schur form (as returned by PDHSEQR_/PDLAHQR_), that is,
...
*  PDHSEQR_/PDLAHQR_ does not compute Schur forms of submatrices anyway.
*
*  References
*  ==========
*
...
*     .. External Subroutines ..
     ...
     $                   IGAMN2D, INFOG2L, PDLACPY, PDTRORD_, PXERBLA,
     $                   PCHK1MAT, PCHK2MAT
*     $                   , PGESYCTD, PSYCTCON
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 .AND. .NOT.LQUERY ) THEN
         ...
         S = ONE
         SEP = ZERO
         CALL PXERBLA( ICTXT, 'PDTRSEN_', -INFO )
         RETURN
      ELSEIF( LQUERY ) THEN
         WORK( 1 ) = DBLE(LWMIN)
         IWORK( 1 ) = LIWMIN
...
*
      CALL PDTRORD_( COMPQ, IWORK, PARA, N, T, IT, JT,
