...
*                                                                     *
***********************************************************************
      SUBROUTINE PDLAQR2_( WANTT, WANTZ, N, KTOP, KBOT, NW, A, DESCA,
...
*
*  PDLAQR2_ accepts as input an upper Hessenberg matrix A and performs an
...
*  one processor. Normally, it is called by PDLAQR1_. All the inputs are
...
*          Normally NW .GE. 3 if PDLAQR2_ is called by PDLAQR1_.
*
