...
*                                                                     *
***********************************************************************
      INTEGER FUNCTION PIPARMQ_( ICTXT, ISPEC, NAME, OPTS, N, ILO, IHI,
     $                          LWORKNB )
*
...
*       PILAENVX_ is called with 12 <= ISPEC <= 16
*
*  Arguments
*  =========
*
...
*              ISPEC specifies which tunable parameter PIPARMQ_ should
*              return.
*
...
*                        PIPARMQ_(ISPEC=14) = 0 causes PxLAQR0 to skip a
*                        multi-shift QR sweep whenever early deflation
*                        finds a converged eigenvalue.  Setting
*                        PIPARMQ_(ISPEC=14) greater than or equal to 100
...
*
*              ISPEC=16: (IACC22) PIPARMQ_ is set to 1 or 2 with the
*                        following meanings.
...
*                        PIPARMQ_(ISPEC=16)=1 may be more efficient than
*                        PIPARMQ_(ISPEC=16)=2 despite the greater level of
...
*       for each of PCHSEQR, PDHSEQR_, PSHSEQR and PZHSEQR.
*
...
*       effective.
*
*       Following is a list of default values supplied by PIPARMQ_.
*       These defaults may be adjusted in order to attain better
*       performance in any particular computational environment.
*
*       PIPARMQ_(ISPEC=12) The PxLAQR1 vs PxLAQR0 crossover point.
*                         Default: 220. (Must be at least 11.)
*
*       PIPARMQ_(ISPEC=13) Recommended deflation window size.
*                         This depends on ILO, IHI and NS, the
*                         number of simultaneous shifts returned
*                         by PIPARMQ_(ISPEC=15).  The default for
*                         (IHI-ILO+1).LE.500 is NS.  The default
*                         for (IHI-ILO+1).GT.500 is 3*NS/2.
*
*       PIPARMQ_(ISPEC=14) Nibble crossover point.
*                         The default for the serial case is 14.
*                         The default for the parallel case is
*                         335 * N**(-0.44) * NPROCS.
*
*       PIPARMQ_(ISPEC=15) Number of simultaneous shifts, NS.
*                         a multi-shift QR iteration.
*
*                         If IHI-ILO+1 is ...
*
...
*                          PxLAQR1.  See PIPARMQ_(ISPEC=12) above. These
...
*
*       PIPARMQ_(ISPEC=16) Select structured matrix multiply.
