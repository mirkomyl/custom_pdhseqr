      SUBROUTINE PDLAHQR_( WANTT, WANTZ, N, ILO, IHI, A, DESCA, WR, WI,
...
*  =======
*
*  PDLAHQR_ is an auxiliary routine used to find the Schur decomposition
...
*          ILO = 1). PDLAHQR_ works primarily with the Hessenberg
...
*          = 0: successful exit
*          > 0: PDLAHQR_ failed to compute all the eigenvalues ILO to IHI
...
*                        back.
*           DLAREF_   -> Row/column reflector applier.  Core routine
*                        here.
...
*
     ...
     $              -1, -1 )
      IF( INFO.LT.0 ) THEN
         CALL PXERBLA( CONTXT, 'PDLAHQR_', -INFO )
         RETURN
      END IF
*
