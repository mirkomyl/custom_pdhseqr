...
*                                                                     *
***********************************************************************
      SUBROUTINE PDLAQR4_( WANTT, WANTZ, N, ILO, IHI, A, DESCA, WR, WI,
...
*  =======
*
*  PDLAQR4_ is an auxiliary routine used to find the Schur decomposition
...
*  Normally, it is called by PDLAQR1_.  All the inputs are assumed to be
...
*          ILO = 1). PDLAQR4_ works primarily with the Hessenberg
...
*          PDLAQR1_. (LDS = 385, see PDLAQR1_)
*
*  INFO    (global output) INTEGER
*          < 0: parameter number -INFO incorrect or inconsistent;
*          = 0: successful exit;
*          > 0: PDLAQR4_ failed to compute all the eigenvalues ILO to IHI
